      ...
      <div className="industry-solutions__container">
        ...
        <div className="industry-solutions__grid">
          {solutions.map((solution) => (
            <div
              key={solution.id}
              className="industry-solutions__card"
              style={
                {
            ...
            >
              ...
              <div
                className="industry-solutions__card-content"
                style={
                  {
                    backgroundColor:
                      solution.id === "trade"
              ...
              >
                <h4 className="industry-solutions__headline">
                  {solution.headline}
                </h4>
                ...
                <a
                  href="#connect"
                  className="industry-solutions__btn"
        ...
        <div className="industry-solutions__info">
          <p>
            Больше не надо подстраиваться под банки: выбирайте сами, как вам
            удобнее принимать платежи!
          </p>
          <p>
            Не нашли свою отрасль? Оставьте заявку и мы разработаем готовое
            решение для вашей сферы деятельности
          </p>
        </div>
