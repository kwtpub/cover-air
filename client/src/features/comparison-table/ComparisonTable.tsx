            ...
            <thead>
              <tr>
                ...
                <th className="comparison-table__th comparison-table__th--udmpay">
                  <span className="comparison-table__header-text">
                    COVER AIR всё включено!
                  </span>
                </th>
                ...
                >
                  ...
                  <td className="comparison-table__td comparison-table__td--udmpay">
                    <span
                      className={
                        row.udmpay
                          ? "comparison-table__value comparison-table__value--good"
                          : ""
                      }
                    >
                      {row.udmpay}
                  ...
                  <td className="comparison-table__td comparison-table__td--competitor">
                    <span
                      className={
                        row.competitor
                          ? "comparison-table__value comparison-table__value--bad"
                          : ""
                      }
                    >
                      {row.competitor}
